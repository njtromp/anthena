...
\bibitem{mathworks} MathWorks Documentation. Retrieve from\\
\url{https://nl.mathworks.com/help/}
\bibitem{pid}J. Sluka. (n.d). A PID Controller For Lego Mindstorms Robots. Retrieve from\\
\url{http://www.inpharmix.com/jps/PID_Controller_For_Lego_Mindstorms_Robots.html}
\bibitem{assignment} Embedded Software and Systems 2018, Practical Project: Traal-Rover.
\end{thebibliography}
